...
export const CtaSection = () => {
  return (
    ...
    >
      <div className="bg-ink text-cream rounded-sm px-6 py-9 sm:p-12">
        <h2 className="font-display text-cream mb-4 text-[clamp(1.5rem,3vw,2rem)] leading-tight font-bold tracking-tight">
          Get in touch or support the work
        </h2>
        <p className="text-warm-stone mb-9 max-w-135 text-base/[1.7]">
        ...
        <div className="flex flex-col flex-wrap items-center items-stretch gap-4 sm:flex-row">
          ...
          <Button
            ...
            size="xl"
            radius="xs"
            className="border-earthy-ash text-warm-stone gap-2 border border-solid data-[disabled]:opacity-100"
        ...
        <div className="border-deep-espresso text-muted mt-8 border-t pt-8 text-sm">
          By using Digital Training Log you agree to our{' '}
          <Link
            to="/terms"
            className="text-taupe hover:text-dusty-beige whitespace-nowrap underline underline-offset-2"
          >
            Terms of Use
          </Link>
          .
