...
export const CtaSection = () => {
  return (
    ...
    >
      <div className="bg-ink text-primary-foreground rounded-sm px-6 py-9 sm:p-12">
        <h2 className="font-display mb-4 text-[clamp(1.5rem,3vw,2rem)] leading-tight font-bold tracking-tight">
        ...
        <div className="flex flex-col flex-wrap items-center items-stretch gap-4 sm:flex-row">
          ...
          <Button
            ...
            size="xl"
            radius="xs"
            className="border-earthy-ash text-secondary gap-2 border border-solid data-[disabled]:opacity-100"
