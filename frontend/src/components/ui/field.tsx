...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        'text-foreground mb-1.5 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base data-[variant=title]:text-2xl data-[variant=title]:font-bold',
        className,
      )}
      {...props}
    />
