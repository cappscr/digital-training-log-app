  ...
  describe "POST /api/v1/pace-calculators" do
    ...
    context "with valid parameters" do
      it "calculates the new pace and returns http success" do
        ...
        expect(json_response["pace_calculation"]).to eq({
          "calculated_pace" => "7:12",
          "units" => "per_mile",
          "original_pace" => "8:00 / mi",
          "percentage" => 110
        })
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "returns unprocessable entity for invalid seconds" do
        ...
        json_response = JSON.parse(response.body)
        expect(json_response["errors"]).to include({ "detail" => "Must be less than 60", "pointer" => "#/pace/seconds" })
      end
